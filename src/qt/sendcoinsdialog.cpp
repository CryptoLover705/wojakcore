    ...
    model(0)
{
    ...
    ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a WojakCoin address (e.g. Ler4HNAEfwYhBmGXcFP2Po1NpRUEiK8km2)"));
#endif
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    CCoinControl *ctrl = NULL;
    if (model && model->getOptionsModel() && model->getOptionsModel()->getCoinControlFeatures())
        ctrl = CoinControlDialog::coinControl;

    WalletModel::SendCoinsReturn rv = model->sendCoins(recipients, ctrl);
    switch(rv.status)
    {
    ...
    case WalletModel::AmountWithFeeExceedsBalance:
        QMessageBox::warning(this, tr("Send Coins"),
            ...
            arg(BitcoinUnits::formatWithUnit(BitcoinUnits::BTC, rv.fee)),
            QMessageBox::Ok, QMessageBox::Ok);
        break;
