...
define $(package)_stage_cmds
  ...
  if [ -d qtbase/mkspecs/modules-inst ]; then \
    cp -r qtbase/mkspecs/modules-inst $($(package)_staging_prefix_dir)/mkspecs/; \
  fi && \
  find $($(package)_staging_prefix_dir)/mkspecs/modules -name '*.pri' -exec sed -i "s|$($(package)_build_dir)/qtbase|$($(package)_staging_prefix_dir)|g" {} \;
endef
